...
The molecular clock hypothesis states that the evolutionary rates of biological sequences, such as nucleotides and amino acids, are approximately constant through time \cite{zuckerkandl1962molecular}.
This assumption forms the basis of phylogenetics, under which the evolutionary trees and divergence dates of life forms are inferred from biological sequences \cite{douzery2003local, drummond2006relaxed}.
...
In this article we compare the performance of uniform and Bactrian proposal kernels with respect to estimating clock model parameters $\vec{\mathcal{R}}^{\,}$ and $\sigma$. Two Bactrian distributions are compared ($m=0.95$ and $m=0.98$). The clock model operators which these proposal kernels apply to are described in \textbf{Table \ref{table:bactriankernels}}.
